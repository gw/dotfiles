...
** Soft-wrap and indent long lines in texty modes
#+BEGIN_SRC emacs-lisp
  (defun gw/soft-wrap-and-indent-mode ()
    "Turn on 'visual-line-mode' and adaptive-wrap-prefix-mode.
  org-mode doesn't need this (it only needs org-indent-mode and)
  visual-line-mode--adaptive-wrap-prefix messes it up."
    (progn
      (turn-on-visual-line-mode)
      (adaptive-wrap-prefix-mode)))

  (add-hook 'text-mode-hook 'gw/soft-wrap-and-indent-mode)
#+END_SRC
