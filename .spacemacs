...
values."
  (setq-default
   ...
   '(
     ...
     (syntax-checking :disabled-for org
                      :variables
     ...
     (auto-completion :disabled-for org
                      ...
                      hippie-exp
                      :variables
                      auto-completion-return-key-behavior nil  ; Enter should insert newline
...
you should place your code here."
  ...
  ;; Soft-wrap long lines in text-y modes
  ...
  ;; When enabled as a minor mode, it will transparently try to set the
  ;; indentation offset and `indent-tabs-mode` if it confidently detect
  ;; what the currently-edited file is doing. It's source code is
  ;; well-documented-just read it if you're having trouble.
  ...
  ;; Ignore stuff in counsel-find-file
