...
you should place your code here."
  ...
  ; Easymotion by beginning of words
  (define-key evil-normal-state-map (kbd "C-s") 'evil-avy-goto-word-or-subword-1)
  ; Toggle active pane
  ...
  ; Kill all other windows. Using spacemacs/set-leader-keys
  ; makes is show up in the hotkey expansion menus
  (spacemacs/set-leader-keys "wD" 'delete-other-windows)
  ; Escape from everything with 'esc'
  ...
  (setq helm-boring-buffer-regexp-list
        '("\\` " "\\*helm" "\\*helm-mode" "\\*Echo Area" "\\*tramp" "\\*Minibuf" "\\*epc"
          "\TAGS$" "\\*scratch" "\\*spacemacs" "\\*Help" "\\*magit" "\\*assembly"
          "\\*dotfile"))
  )
